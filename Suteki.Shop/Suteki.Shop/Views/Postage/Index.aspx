<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Shop.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Suteki.Shop.Views.Postage.Index" %>
...
<% foreach(var postage in ViewData.Model.Items) { %>
    <tr>
